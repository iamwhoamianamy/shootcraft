...
namespace shootcraft.src
{
   public static class GameHelper
   {
      ...
      {
         return (float)(GameHelper.random.NextDouble() * (right - left) + left);
      }
      ...
      public static Color4 CreateRandomColor()
      {
         return new Color4
         {
            R = (float)GameHelper.random.NextDouble(),
            G = (float)GameHelper.random.NextDouble(),
            B = (float)GameHelper.random.NextDouble(),
            A = (float)GameHelper.random.NextDouble()
         };
      }
